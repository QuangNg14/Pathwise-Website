...
import './FAQ.css'; // Assuming you have a CSS file for custom styles
...
const FAQ = () => {
  const faqData = [
    ...
    {
      question: 'Câu chuyện bắt đầu của Pathspire là gì?',
      answer: [
        ...
        'Trong thời gian đó, không có sự hỗ trợ từ các nguồn mentor, đội ngũ mentor của Pathspire đã phải tự tìm tòi, hỏi han khắp nơi, và kết quả hầu như về kiến thức lẫn tài liệu đều mơ hồ và không hề hiệu quả, lãng phí thời gian và mất phương hướng.',
    ...
    {
      question: 'Tại sao nên tham gia làm mentee vào Pathspire?',
      answer: [
        'Hiệu quả - Tập trung vào những kiến thức cụ thể và cô đọng nhất để phục vụ quá trình ứng tuyển vào các tập đoàn lớn.',
        'Tiết kiệm - Chi phí được tối ưu sao cho phù hợp với sinh viên nhất, và đảm bảo tiết kiệm hơn từ 50-60% so với thị trường.',
  ...
  return (
    <div className="faq-container">
      <Text level={2} className="faq-title">Frequently Asked Questions</Text>
