...
const companyLogos = {
  ...
  meta: (
    <svg className="company-logo" viewBox="0 0 24 24" fill="#1877F2">
      ...
      <text x="12" y="16" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold" fontFamily="Arial, sans-serif">f</text>
    </svg>
  ),
  paypal: (
    <svg className="company-logo" viewBox="0 0 24 24">
      <path fill="#003087" d="M7.076 21.337H2.47a.641.641 0 0 1-.633-.74L4.944.901C5.026.382 5.474 0 5.998 0h7.46c2.57 0 4.578.543 5.69 1.81 1.01 1.15 1.304 2.42 1.012 4.287-.023.143-.047.288-.077.434-.983 4.237-4.053 6.199-8.74 6.199h-1.92c-.424 0-.79.308-.85.728l-.542 3.79-.024.168a.641.641 0 0 1-.633.57z"/>
      <path fill="#009CDE" d="M18.446 3.005c-.983 4.237-4.053 6.199-8.74 6.199h-1.92c-.424 0-.79.308-.85.728l-.542 3.79-.024.168a.641.641 0 0 1-.633.57H2.47a.641.641 0 0 1-.633-.74L4.944.901C5.026.382 5.474 0 5.998 0h7.46c2.57 0 4.578.543 5.69 1.81.302.345.5.729.65 1.134z"/>
    </svg>
  ),
  adobe: (
  ...
  'morgan-stanley': (
    <svg className="company-logo" viewBox="0 0 24 24" fill="#0F4C8C">
      ...
      <text x="12" y="14" textAnchor="middle" fill="white" fontSize="8" fontWeight="bold" fontFamily="Arial, sans-serif">MS</text>
    </svg>
  )
};
...
const mentors = [
  {
    name: "Gia Hy",
    image: "https://res.cloudinary.com/dbqcioj2g/image/upload/v1730616070/bh5pqnyayotoxprcoafs.jpg",
    university: "University of South Florida",
    offers: "Software Engineer Intern, Meta\nSoftware Engineer Intern, Microsoft",
    companies: ["meta", "microsoft"]
  },
  {
    name: "Hoàng Quỳnh Hương",
    image: "https://res.cloudinary.com/dbqcioj2g/image/upload/v1730615998/wzq64kqpmmkkdsypdf1f.jpg",
  ...
  },
  {
    ...
    image: "http://res.cloudinary.com/dbqcioj2g/image/upload/v1730773203/jafp7uywccmrdsibqcus.jpg",
    university: "University of South Florida",
    offers: "Software Engineer Intern, Adobe\nSoftware Engineer Intern, Morgan Stanley\nProduction Engineer Intern, Meta\nSoftware Engineer Intern, Microsoft",
