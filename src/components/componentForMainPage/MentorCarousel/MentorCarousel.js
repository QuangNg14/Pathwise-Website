      ...
      <div className="mentor-section-content">
        ...
        <div className="mentor-cards-container">
          {mentors.map((mentor, index) => {
            ...
            const bioData = mentorBioData[mentor.name] || { bio: ["Bio coming soon..."], role: "Mentor" };
            
            return (
              <div key={index} className={`mentor-card-item ${isExpanded ? 'expanded' : ''}`}>
                <div 
                  className={`mentor-card-header ${isExpanded ? 'expanded' : ''}`}
                ...
                <div className={`mentor-card-content ${isExpanded ? 'expanded' : ''}`}>
                  <div className="mentor-content-inner">
                    ...
                    <div className="mentor-bio">
                      {bioData.bio.map((paragraph, paragraphIndex) => (
                        <div key={paragraphIndex} className="mentor-bio-section">
                          {paragraph}
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="mentor-actions">
                      ...
                      >
                        Go to LinkedIn <LinkedinOutlined className="linkedin-icon" />
                      </a>
                    </div>
                  </div>
                </div>
