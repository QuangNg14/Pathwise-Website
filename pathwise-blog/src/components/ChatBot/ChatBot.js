...
const ChatBot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hi! I'm your Pathwise Blog AI assistant. How can I help you with your career journey or any blog-related questions today?",
      sender: 'bot',
            ...
            <div className="chatbot-input-area">
              <div className="chatbot-input-container">
                <input
                  ...
                  placeholder="Ask me about career development, algorithms, tech trends..."
                  value={newMessage}
